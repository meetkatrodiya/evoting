      ...
      <Table sx={{ minWidth: 650 }} size="medium" aria-label="a dense table">
        ...
        <TableHead style={{backgroundColor:"#00003B"}}>
          <TableRow>
            ...
            <TableCell style={{color:"#ffffff", fontSize:16}}>Party Vote</TableCell>
            <TableCell style={{color:"#ffffff", fontSize:16}}>Total Vote</TableCell>
          ...
          {rows.map((row) => (
            ...
            >
              {/* <TableCell component="th" scope="row">
                ...
                <>
                <TableCell style={{ fontSize:15}}>{row.statename}</TableCell>
                <TableCell style={{ fontSize:15}}>{party.partyname}</TableCell>
                <TableCell style={{ fontSize:15}}>{party.count}</TableCell>
                </>
