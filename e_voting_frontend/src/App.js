...
import VoterResult from "./Components/Result/Chart/Voter/index";

// import Result from "./Components/Result/index";
// remove Home.js and layout folder from result...
  ...
  return (
    <Router>
        ...
        <Route path='/'>
          ...
          <Route exact path="voterresult" element={<VoterResult/>} />
          </Route>
        </Routes>
      </Router>
  );
